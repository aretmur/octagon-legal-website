    ...
    <section id="our-team" className="py-20 bg-white">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-serif font-bold text-navy mb-3">Our Exceptional Team</h2>
        ...
        {/* ==============================
            MODAL — CLICK OUTSIDE TO CLOSE + X ALWAYS VISIBLE
        =============================== */}
        {open && (
          <div
            className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4"
            onClick={() => setOpen(null)} // close on outside click
          >
            <div
            ...
            >
              ...
              <div className="p-8 pt-16">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <h3 className="text-3xl font-serif font-bold text-navy">{open.name}</h3>
