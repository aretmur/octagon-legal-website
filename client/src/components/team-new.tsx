...
// Actual team photos
const williamBillingsImage = "/images/IMG_4851_1753919805052.jpg";
const aretMuradyanImage = "/images/IMG_4238 2_1753919866092.JPG";
const friznikBonyImage = "/images/ChatGPT Image Jul 31, 2025, 02_27_18 PM_1753936048598.png";
...
const teamMembers = [
  ...
  },
  {
    ...
    description: "Friznik Bony leads the Family and Immigration Law practice at Octagon Legal, bringing deep expertise, strategic calm, and unwavering client advocacy to two of the most sensitive areas in law."
  },
  {
    ...
    subtitle: "",
    languages: ["English"],
    image: "/images/IMG_5154_1753926849979.jpg",
...
export default function Team() {
  ...
  return (
    <section id="our-team" className="py-responsive-lg bg-white">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-responsive-sm relative">
                    ...
                    {selectedMember.languages && (
                      <div className="mb-3 sm:mb-4">
                        <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                          {selectedMember.languages.map((lang, langIndex) => (
                            <span key={langIndex} className="inline-block bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm font-medium">
                              {lang}
                            </span>
                          ))}
                        </div>
                ...
                <div className="text-responsive-xs text-gray-700 leading-relaxed space-y-4">
